                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="tags" class="form-control" type="tags" name="tags" value="{{ $article->tags }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="payment_category_id" class="form-control" name="payment_category_id">
                                    @foreach ($payment as $item)
                                        <option value="{{ $item->id }}" {{ $item->id == $article->payment_category_id  ? 'selected' : ''}}>{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                           </div>
                           ...
                           <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="price" class="form-control" type="number" name="price" value="{{ $article->price }}">
                            </div>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="type_id" class="form-control" name="type_id">
                                            @foreach ($type as $item)
                                                <option value="{{ $item->id }}" {{ $item->id == $article->type_id  ? 'selected' : ''}}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="max_age" class="form-control" type="text" name="max_age" value="{{ $article->max_age }}">
                                        </div>
                                    </div>
